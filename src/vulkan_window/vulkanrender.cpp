...
void VulkanRenderer::initResources()
{
    ...
    // Shaders
    VkShaderModule vertShaderModule = createShader(QStringLiteral("shader/color_vert.spv"));
    VkShaderModule fragShaderModule = createShader(QStringLiteral("shader/color_frag.spv"));
